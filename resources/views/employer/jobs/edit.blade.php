                        ...
                        <form action="{{ route('employer.jobs.update', $job) }}" method="POST" id="jobEditForm">
                            ...
                            <div class="form-section">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="d-flex gap-4 mt-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="is_oep_pakistan" id="oep_yes" value="1" {{ old('is_oep_pakistan', $job->is_oep_pakistan) == '1' ? 'checked' : '' }}>
                                                    <label class="form-check-label" for="oep_yes">
                                                        Yes
                                                    </label>
                                                </div>
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="is_oep_pakistan" id="oep_no" value="0" {{ old('is_oep_pakistan', $job->is_oep_pakistan, '0') == '0' ? 'checked' : '' }}>
                                    ...
                                    <div class="col-lg-12" id="oep_permission_field" style="display: {{ old('is_oep_pakistan', $job->is_oep_pakistan) == '1' ? 'block' : 'none' }};">
                                        <div class="form-group">
                                            <label class="form-label">Permission# <sup class="text-danger">*</sup></label>
                                            <input type="text" name="oep_permission_number" id="oep_permission_number" class="form-control @error('oep_permission_number') is-invalid @enderror" value="{{ old('oep_permission_number', $job->oep_permission_number) }}" placeholder="Enter Permission Number">
