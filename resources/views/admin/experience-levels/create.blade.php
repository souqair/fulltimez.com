...
@section('title', 'Create Experience Level')
@section('page-title', 'Create Experience Level')
    ...
    <div class="col-lg-8">
        <div class="admin-card">
            <div class="admin-card-header">
                <h5><i class="fas fa-plus"></i> Create New Experience Level</h5>
                <a href="{{ route('admin.experience-levels.index') }}" class="admin-btn admin-btn-secondary btn-sm">
                    <i class="fas fa-arrow-left"></i> Back
                </a>
            </div>
            <div class="admin-card-body">
                <form action="{{ route('admin.experience-levels.store') }}" method="POST">
                    @csrf
